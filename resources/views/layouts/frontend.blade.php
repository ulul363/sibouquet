                        ...
                        @if (!\Cart::isEmpty())
                            <ul class="cart-dropdown">
                                ...
                                <li class="cart-btn-wrapper">
                                    ...
                                    <a class="cart-btn btn-hover"
                                        href="https://wa.me/6285802801261?text=Hallo%20,%20Saya%20Ingin%20Membeli%20Produk%20Buket%20Yang%20Anda%20Jual%20">checkout</a>
                                </li>
                            </ul>
                        @endif
                    </div>
                ...
                <div class="widget-wrapper">
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer-about-2">
                            <p>Kami akan menyajikan Anda buket yang memukau, <br> sesuai dengan selera dan keinginan
                                Anda.<br> Datang dan buktikan sendiri pesona keindahan bunga di toko kami! <br>Queen
                                Bouquet</p>
                        </div>
                    </div>
                    <div class="footer-widget mb-30">
                        ...
                        <div class="footer-info-wrapper-3">
                            <div class="footer-address-furniture">
                                ...
                                <div class="footer-info-content3">
                                    <p>Jalan Kinibalu, Sidanegara, Cilacap</p>
                                </div>
                            </div>
                            <div class="footer-address-furniture">
                                <div class="footer-info-icon3">
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="copyright-furniture">
                            <p>Copyright © Kelompok 5 PP</a> 2023.
                            </p>
                        </div>
                    </div>
                </div>
